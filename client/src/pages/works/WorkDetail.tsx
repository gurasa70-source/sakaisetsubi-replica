...
export default function WorkDetail() {
  ...
  const worksData: Record<string, any> = {
    ...
    'new-construction-1': {
      ...
      image: 'https://via.placeholder.com/800x600?text=新築給排水工事',
      content: {
        workContent: '新築住宅の給排水配管工事',
        requestContent: '新築住宅の給排水配管工事を一貫して対応してほしいとのご相談でした。',
        cause: '工務店様からのご依頼で、設計段階からの相談が必要でした。',
        method: '設計段階からの相談、施工、検査まで一貫して実施いたしました。',
        comment: '建築スケジュールに合わせた柔軟な対応で、工期を短縮することができました。',
        service: '新築給排水工事',
