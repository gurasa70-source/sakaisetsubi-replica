        ...
        <div className="relative h-full flex items-center">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <h1 className="text-4xl font-bold leading-[1.2] text-balance text-white mb-4 sm:text-5xl md:text-6xl">
              <span className="flex items-center gap-3"><ServiceIcon name="water-tap" className="w-10 h-10 shrink-0 sm:w-12 sm:h-12" />分水工事</span>
            </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {[
                ...
                <div key={index} className="bg-gradient-to-br from-blue-50 to-slate-50 p-8 rounded-lg border border-blue-100 hover:shadow-lg transition">
                  <div className="w-12 h-12 mb-5 rounded-lg bg-blue-100 text-blue-700 flex items-center justify-center"><ServiceIcon name={item.icon as "water-tap" | "building" | "road" | "equipment"} className="w-7 h-7" /></div>
